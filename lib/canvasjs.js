...
(function () {
    ...
    Chart.prototype.renderColumn = function (plotUnit) {
        ...
        var barWidth = ((((plotArea.width / Math.abs(plotUnit.axisX.maximum - plotUnit.axisX.minimum)) * Math.abs(xMinDiff)) / plotUnit.plotType.totalDataSeries * .9)/2) << 0;
    ...
    Chart.prototype.renderBar = function (plotUnit) {
         ...
         * @type @exp;plotUnit@pro;plotType@pro;totalDataSeries|@exp;plotArea@pro;height|@exp;Math@call;abs|Number|@exp;_L23@pro;Chart@pro;prototype@pro;renderBar@pro;maxBarWidth|@exp;_L23@pro;Chart@pro;prototype@pro;renderBar@pro;maxBarWidth|Number
         */
        var barWidth = ((((plotArea.height / Math.abs(plotUnit.axisX.maximum - plotUnit.axisX.minimum)) * Math.abs(xMinDiff)) / plotUnit.plotType.totalDataSeries * .9)/2) << 0;
